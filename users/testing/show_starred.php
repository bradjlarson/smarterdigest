...
and a.id > (c.starting_id - 30)) d, (select article_id, prediction, sum(ignore_flag) as num_ignore, sum(like_flag) as num_like, sum(star_flag) as num_star from test_user_activity where user_name = 'testing' group by 1) b
