...
mysql_select_db('jobs');
	if ($_SESSION['username'] == "testing")
	{
		if ($_SESSION['pwd'] == "testing")
		{
			$sql = "INSERT into test_user_access (user_name, access_type, access_time_stamp, session_id) values ('testing', 'Login Success', now(), '$sesh_id')";
			$exec = mysql_query($sql);
			$user_predictions = '/Dropbox/Coding/smarterdigest/engine/users/testing_predictions.php';
			include($user_predictions);
		}
		else
		{
			$sql = "INSERT into test_user_access (user_name, access_type, access_time_stamp, session_id) values ('testing', 'Login PWD Fail', now(), '$sesh_id')";
			$exec = mysql_query($sql);
