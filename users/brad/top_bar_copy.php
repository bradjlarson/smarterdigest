...
//echo '         <li class="last"><a href="#"><span>Articles Starred: </span></a></li>' . PHP_EOL;
echo '      </ul>' . PHP_EOL;
echo '   </li>' . PHP_EOL;
...
echo '         <li><a href="#"><span onclick="reload_site()">Reload with updated predictions</span></a></li>' . PHP_EOL;
echo '         <li><a href="#"><span>Load current view of HN</span></a></li>' . PHP_EOL;
echo '         <li class="last"><a href="#"><span>Submit suggestion or bug</span></a></li>' . PHP_EOL;
echo '      </ul>' . PHP_EOL;
echo '   </li>' . PHP_EOL;
echo '   <li><a href="acct_mgmt.php"><span>Acct Mgmt</span></a></li>' . PHP_EOL;
