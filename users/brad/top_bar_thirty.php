...
and a.id > (c.starting_id - 30)) d, (select article_id, prediction, sum(ignore_flag) as num_ignore, sum(like_flag) as num_like from test_user_activity where user_name = 'brad' group by 1 order by id desc limit 30) b
...
echo '<ul>' . PHP_EOL;
echo '   <li><a href="#"><span>Welcome, brad</span></a></li>' . PHP_EOL;
