...
mysql_select_db('jobs');
	if ($_SESSION['username'] == "jack")
	{
		if ($_SESSION['pwd'] == "off")
		{
			$sql = "INSERT into test_user_access (user_name, access_type, access_time_stamp, session_id) values ('jack', 'Login Success', now(), '$sesh_id')";
			$exec = mysql_query($sql);
			$user_predictions = '/Dropbox/Coding/smarterdigest/engine/users/jack_predictions.php';
			include($user_predictions);
		}
		else
		{
			$sql = "INSERT into test_user_access (user_name, access_type, access_time_stamp, session_id) values ('jack', 'Login PWD Fail', now(), '$sesh_id')";
			$exec = mysql_query($sql);
