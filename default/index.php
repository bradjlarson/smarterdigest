...
mysql_select_db('jobs');
	if ($_SESSION['username'] == "$username")
	{
		...
		{
			$sql = "INSERT into test_user_access (user_name, access_type, access_time_stamp, session_id) values ('$username', 'Login Success', now(), '$sesh_id')";
			$exec = mysql_query($sql);
			$user_predictions = '/Dropbox/Coding/smarterdigest/engine/users/$username_predictions.php';
			include($user_predictions);
		}
		else
		{
			$sql = "INSERT into test_user_access (user_name, access_type, access_time_stamp, session_id) values ('$username', 'Login PWD Fail', now(), '$sesh_id')";
			$exec = mysql_query($sql);
